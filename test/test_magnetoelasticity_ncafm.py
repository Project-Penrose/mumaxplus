...
class TestMelNcAfm:
    ...
    def setup_class(self):
        ...
        # magnetoelasticity for all sublattices
        self.magnet.B1 = B1
        self.magnet.B2 = B2
    ...
    def test_different_magnetoelastic_force(self):
        ...
        assert not (np.all(self.magnet.sub1.magnetoelastic_force.eval() ==
                           self.magnet.sub2.magnetoelastic_force.eval()) \
                 or np.all(self.magnet.sub2.magnetoelastic_force.eval() ==
                         self.magnet.sub3.magnetoelastic_force.eval()) \
                 or np.all(self.magnet.sub1.magnetoelastic_force.eval() ==
                         self.magnet.sub3.magnetoelastic_force.eval()))
    ...
    def test_magnetoelastic_field_sub3(self):
        """Check magnetoelastic field of sublattice 3."""
        check_magnetoelastic_field(self.magnet, self.magnet.sub3)
    ...
    def test_total_energy_energy(self):
        ...
        energy_density = (self.magnet.sub1.total_energy_density.eval() + \
                          ...
                          self.magnet.sub3.total_energy_density.eval() + \

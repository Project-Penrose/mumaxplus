...
w1 = GAMMALL_DEFAULT * (wmagnon + wext)
w2 = GAMMALL_DEFAULT * (wmagnon - wext)
w3 = GAMMALL_DEFAULT * (-wmagnon + wext)
w4 = GAMMALL_DEFAULT * (-wmagnon - wext)
...
ax.axhline(GAMMALL_DEFAULT * Bz / (2 * np.pi), c='g', ls='--', lw=1)
